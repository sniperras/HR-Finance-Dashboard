...
// Define the cost center names for each department (using SHORT codes that match database)
...
try {
    ...
    foreach ($costCenters as $code => $data) {
        ...
        $costCenterName = $deptCostCenters[$costCenterCode] ?? $data['name'] ?? $costCenterCode;
        ...
        // Sync to master_performance_data for ALL cost centers
